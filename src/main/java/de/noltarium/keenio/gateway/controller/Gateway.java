...
public class Gateway {
	...
	public void receiveTravisCINotification(@RequestBody MultiValueMap<String, Object> analisticData) throws JsonParseException, JsonMappingException, IOException {
